    ...
    <div class="row justify-content-center">
         <div class="col-md-6 offset-md-6">
            <form method="post" action="reg_code.php" class="form-group" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="town_village">Enter Your Village/City/Town*</label>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="treatment_type">Choose Treatment Type *</label>
                    <select id="treatment_type" name="treatment_type" class="form-control" required>
                ...
                <div class="form-group">
                    <label for="has_field_assistant">Do you have a Field Assistant?</label>
                    <input type="checkbox" id="has_field_assistant" name="has_field_assistant" value="1">
                </div>

                <div class="form-group">
                    <label for="field_asst">Enter Your Field Assistant's Name (if any)</label>
                    <input type="text" id="field_asst" name="field_asst" class="form-control">
                </div>

                <div class="form-group">
                    <label for="field_asst_phone">Enter Your Field Assistant's Phone Number (if any)</label>
                    <input type="text" id="field_asst_phone" name="field_asst_phone" class="form-control">
                </div>

                <div class="form-group">
                    <label for="field_asst_email">Enter Your Field Assistant's Email (if any)</label>
                    <input type="text" id="field_asst_email" name="field_asst_email" class="form-control">
                </div>
