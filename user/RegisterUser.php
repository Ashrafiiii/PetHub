    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <form method="post" action="reg_code.php" class="form-group" enctype="multipart/form-data">
                <h2 class="text-center">Owner Registration</h2>
                ...
                <div class="form-group">
                    <label for="pets_quant">How many pets do you have? *</label>
                    <input type="pets_quant" id="pets_quant" name="pets_quant" class="form-control" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="town_village">Enter Your City/Town/Village *</label>
